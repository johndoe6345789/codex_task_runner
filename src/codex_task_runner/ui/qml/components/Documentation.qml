            ...
            delegate: Loader {
                ...
                sourceComponent: {
                    switch (modelData.type) {
                        case "h1": return h1Component
                        case "h2": return h2Component
                        case "p": return pComponent
                        case "code": return codeComponent
                        case "ul": return ulComponent
                        default: return null
                    }
                }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        // Copy to clipboard would require platform integration
                        console.log("Copy:", itemData.text)
                    }
                }
            }
        }

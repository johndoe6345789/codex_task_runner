 ...
 * Full-featured task manager with built-in themes and i18n
 */
ApplicationWindow {
    id: window
    visible: true
    ...
    property var themeColors: allThemes["dark"]
    property var tr: allTranslations["en"]
